...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
		...
		if(isset($_GET['dir'])){
			$this->targetDir = $_GET['dir'];
		}
		
        $this->options = array(
            'script_url' => $this->get_full_url().'/',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/'.$this->targetDir.'/',
            'upload_url' => $this->get_full_url().'/'.$this->targetDir.'/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
