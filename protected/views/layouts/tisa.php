		...
		<nav id="side_nav">
			<ul>
				...
				<li>
					...
					<div class="sub_panel">
						<div class="side_inner">
							<h4 class="panel_heading">Catalog</h4>
							<ul>
								<li><a href="<?php echo $this->baseUrl();?>/ecommerce/products">Products</a></li>
								<li><a href="<?php echo $this->baseUrl();?>/ecommerce/categories">Categories</a></li>
								<li><a href="ecommerce_products_list.html">Wrapping Gift</a></li>
							</ul>
							<h4 class="panel_heading">Sales</h4>
							<ul>
